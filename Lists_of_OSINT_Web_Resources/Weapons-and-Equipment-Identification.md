...
- [Armalytics](https://www.armalytics.ca/)  
  ...
  Its a digital version of the the Canadian RCMP Firearms Reference Table (FRT). You can download the full FRT in .pdf format from [here](https://www.rcmp-grc.gc.ca/en/firearms/firearms-reference-table), which is constantly being updated. An archived copy created on 3/11/2021 can be found [here (Wayback)](https://web.archive.org/web/20211203095856/https://mpfirearmspublicstore.blob.core.windows.net/firearms-reference-table/frt-traf-eng.pdf).
